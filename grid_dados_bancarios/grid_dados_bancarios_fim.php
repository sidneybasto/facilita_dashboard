...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["facilita_____grid_dados_bancarios"]))
   {
      unset($_SESSION['session_sec_aplicacao']["facilita_____grid_dados_bancarios"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dados_bancarios']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_dados_bancarios']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dados_bancarios']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_dados_bancarios']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_dados_bancarios']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_dados_bancarios</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_dados_bancarios']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_dados_bancarios']['embutida_filho'] as $ind => $sc_init)
          {
