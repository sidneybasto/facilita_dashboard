...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["facilita_____grid_login"]))
   {
      unset($_SESSION['session_sec_aplicacao']["facilita_____grid_login"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_login']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_login']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_login']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_login']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_login']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_login']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_login']['embutida_filho'] as $ind => $sc_init)
          {
