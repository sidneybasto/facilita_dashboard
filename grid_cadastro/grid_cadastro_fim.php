...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["facilita_____grid_cadastro"]))
   {
      unset($_SESSION['session_sec_aplicacao']["facilita_____grid_cadastro"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cadastro']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cadastro']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cadastro']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cadastro']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cadastro']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cadastro']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cadastro']['embutida_filho'] as $ind => $sc_init)
          {
