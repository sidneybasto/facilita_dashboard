...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["facilita_____chart_simulacao"]))
   {
      unset($_SESSION['session_sec_aplicacao']["facilita_____chart_simulacao"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_simulacao']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_simulacao']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_simulacao']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_simulacao']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_simulacao']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_simulacao']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_simulacao']['embutida_filho'] as $ind => $sc_init)
          {
