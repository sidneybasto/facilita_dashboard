...
class chart_simulacao_res_xls
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xlsx";
      $this->Tit_doc    = "chart_simulacao.xlsx";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['xls_name']);
      }
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['arr_export']['data'];
      $b_display = false;
      $contr_rowspan = array();
      $contr_colspan = array();
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_title'] ?> simulacao :: Excel</TITLE>
