...
class chart_simulacao_resumo
{
   ...
   var $conv_col;
   var $count_ger;
   var $cnt_valorsolicitado;
   var $sc_proc_quebra_created_at;
   var $count_created_at;
   var $cnt_created_at_valorsolicitado;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_created_at = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_simulacao'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_simulacao'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_simulacao']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_simulacao']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_simulacao']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_step']     = 'image';
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['phantomjs_export_process'] = false;
	...
	function zipChartImages() {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages);

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList) {
		...
		$tempDir = $this->Ini->root . $_SESSION['scriptcase']['chart_simulacao']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['chart_simulacao']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['campos_busca'];
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_combination_type']        = 'column2d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_combination_order_rule']  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_combination_order_field'] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_combination_order_rule_groupby']["created_at"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_combination_order_field_groupby']["created_at"] = 'label';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_y_axys'][0] = 0;
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['comb_field_display_type'][2] = '';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_display_values'][2] = null;


           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_order']['sc_free_group_by'][] = 2;
       }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pesq_tab_label'] = "";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_search_add']);
          exit;
      }
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("chart_simulacao", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['arr_total']['created_at'] = $this->array_total_created_at;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $Lab_created_at = "Created At";
       $Lab_created_at =  sprintf("" . $this->Ini->Nm_lang['lang_othr_chart_title_MM'] . " created_at", $Lab_created_at);
       $prep_field = array();
       $prep_field['created_at'] = $Lab_created_at;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['labels']['created_at'] = $Lab_created_at; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       //-----
       $this->comp_sum = array(
           2 => "Valor Solicitado (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "valorsolicitado", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_valorsolicitado_cnt",
       );

       //-----
       $this->comp_sum_nm = array(
           2 => "valorsolicitado_cnt",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['created_at']['alin'] = "''";
       $Arr_parms['created_at']['link'] = "S";
       $Arr_parms['created_at']['fill'] = "true";
       $Arr_parms['created_at']['order'] = "value";
       $Arr_parms['created_at']['order_start'] = 'asc';
       $Arr_parms['created_at']['order_invert'] = 'false';
       $Arr_parms['created_at']['order_enabled'] = 'true';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['created_at'] = array(0 => 'created_at', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_simulacao@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           'created_at' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Solicitado (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'created_at',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_created_at)),
               'label_y'  => $this->getChartText(strip_tags("Valor Solicitado (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_order']['sc_free_group_by'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_chart_simulacao_' . session_id() . '_!!!C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__!!!.json' : '',
                               'xml'         => 'sc_chart_simulacao_' . session_id() . '_!!!C_' . $i_index_group . '_' . $s_index_comb . '!!!.json',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
	...
	function filterChartsByMultiseries() {
		...
		if ($applyFilter && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['summarizing_drill_down'])) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_charts'] as $chartIndex => $chartData) {
				$indexParts = explode('|', $chartIndex);
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_chart_simulacao_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_chart_simulacao_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
      ...
      { 
         ...
         { 
             $seq_search = 1;
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_pesq'] as $cmp => $def)
             {
                $Seq_grid      = $seq_search;
                $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_simulacao']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_simulacao']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_simulacao']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_simulacao']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_simulacao_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['opcao'] = "print";
      ...
      $this->Total   = new chart_simulacao_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " simulacao</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_simulacao_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_simulacao_jquery.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_simulacao_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_simulacao_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_simulacao_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_simulacao/chart_simulacao_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("         dataType: \"html\",\r\n");
           $nm_saida->saida("         url: \"chart_simulacao_save_grid.php\",\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['ajax_nav'] && !$this->Ini->sc_export_ajax)
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['embutida'])
      {
      ...
      $nm_saida->saida("  scShowCombinationImage($(\".sc-id-chart-image-level\").filter(\":checked\").val(), $(\"#sc-id-image-export-type\").val());\r\n");
      $nm_saida->saida("}\r\n");
      $nm_saida->saida("</script>\r\n");
      ...
      $nm_saida->saida("  scBlockUI();\r\n");
      $nm_saida->saida("  $(\"#sc-id-word-export-type\").val(exportType);\r\n");
      $nm_saida->saida("  $(\"#sc-id-word-export-config\").css({\r\n");
      $nm_saida->saida("    \"margin-left\": -$(\"#sc-id-word-export-config\").outerWidth()/2,\r\n");
      $nm_saida->saida("    \"margin-top\": -$(\"#sc-id-word-export-config\").outerHeight()/2\r\n");
      $nm_saida->saida("  }).show();\r\n");
      $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("  scShowCombinationWord($(\"#sc-id-word-export-type\").val(), $(\"#sc-id-chart-word-color\").val());\r\n");
      $nm_saida->saida("}\r\n");
      $nm_saida->saida("</script>\r\n");
...
;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['embutida'])
      {
         ...
         $nm_saida->saida("        $('#chart_bar_top').css('display', 'none');\r\n");
         $nm_saida->saida("        $('#chart_bar_on_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("       }\r\n");
         $nm_saida->saida("       else {\r\n");
         $nm_saida->saida("        $('#chart_bar_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("        $('#chart_bar_on_top').css('display', 'none');\r\n");
         $nm_saida->saida("       }\r\n");
         $nm_saida->saida("       $('#chart_bar_off_top').css('display', 'none');\r\n");
         $nm_saida->saida("      }\r\n");
         $nm_saida->saida("      function scDisableBarChartButton_top() {\r\n");
         $nm_saida->saida("       $('#chart_bar_top').css('display', 'none');\r\n");
         $nm_saida->saida("       $('#chart_bar_on_top').css('display', 'none');\r\n");
         $nm_saida->saida("       $('#chart_bar_off_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("      }\r\n");
         $nm_saida->saida("     </script>\r\n");
         if ($this->nmgp_botoes['chart_bar'] == 'on') {
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_bar", "scChangeChartTypeButton('column2d');", "scChangeChartTypeButton('column2d');", "chart_bar_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "\$('#chart_bar_top').css('display', 'none');\$('#chart_bar_on_top').css('display', 'inline-block');", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_bar_on", "scChangeChartTypeButton('column2d');", "scChangeChartTypeButton('column2d');", "chart_bar_on_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "if (tp_graf_atual != 'bar'){\$('#chart_bar_on_top').css('display', 'none');\$('#chart_bar_top').css('display', 'inline-block');}", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_bar_off", "", "", "chart_bar_off_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
         }
         $nm_saida->saida("     <script type=\"text/javascript\">\r\n");
         ...
         $nm_saida->saida("        $('#chart_line_top').css('display', 'none');\r\n");
         $nm_saida->saida("        $('#chart_line_on_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("       }\r\n");
         $nm_saida->saida("       else {\r\n");
         $nm_saida->saida("        $('#chart_line_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("        $('#chart_line_on_top').css('display', 'none');\r\n");
         $nm_saida->saida("       }\r\n");
         $nm_saida->saida("       $('#chart_line_off_top').css('display', 'none');\r\n");
         $nm_saida->saida("      }\r\n");
         $nm_saida->saida("      function scDisableLineChartButton_top() {\r\n");
         $nm_saida->saida("       $('#chart_line_top').css('display', 'none');\r\n");
         $nm_saida->saida("       $('#chart_line_on_top').css('display', 'none');\r\n");
         $nm_saida->saida("       $('#chart_line_off_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("      }\r\n");
         $nm_saida->saida("     </script>\r\n");
         if ($this->nmgp_botoes['chart_line'] == 'on') {
            ...
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_line_off", "", "", "chart_line_off_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
         }
         $nm_saida->saida("     <script type=\"text/javascript\">\r\n");
         ...
         $nm_saida->saida("        $('#chart_area_top').css('display', 'none');\r\n");
         $nm_saida->saida("        $('#chart_area_on_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("       }\r\n");
         $nm_saida->saida("       else {\r\n");
         $nm_saida->saida("        $('#chart_area_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("        $('#chart_area_on_top').css('display', 'none');\r\n");
         $nm_saida->saida("       }\r\n");
         $nm_saida->saida("       $('#chart_area_off_top').css('display', 'none');\r\n");
         $nm_saida->saida("      }\r\n");
         $nm_saida->saida("      function scDisableAreaChartButton_top() {\r\n");
         $nm_saida->saida("       $('#chart_area_top').css('display', 'none');\r\n");
         $nm_saida->saida("       $('#chart_area_on_top').css('display', 'none');\r\n");
         $nm_saida->saida("       $('#chart_area_off_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("      }\r\n");
         $nm_saida->saida("     </script>\r\n");
         if ($this->nmgp_botoes['chart_area'] == 'on') {
            ...
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_area_off", "", "", "chart_area_off_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
         }
         $nm_saida->saida("     <script type=\"text/javascript\">\r\n");
         ...
         $nm_saida->saida("        $('#chart_pizza_top').css('display', 'none');\r\n");
         $nm_saida->saida("        $('#chart_pizza_on_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("       }\r\n");
         $nm_saida->saida("       else {\r\n");
         $nm_saida->saida("        $('#chart_pizza_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("        $('#chart_pizza_on_top').css('display', 'none');\r\n");
         $nm_saida->saida("       }\r\n");
         $nm_saida->saida("       $('#chart_pizza_off_top').css('display', 'none');\r\n");
         $nm_saida->saida("      }\r\n");
         $nm_saida->saida("      function scDisablePieChartButton_top() {\r\n");
         $nm_saida->saida("       $('#chart_pizza_top').css('display', 'none');\r\n");
         $nm_saida->saida("       $('#chart_pizza_on_top').css('display', 'none');\r\n");
         $nm_saida->saida("       $('#chart_pizza_off_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("      }\r\n");
         $nm_saida->saida("     </script>\r\n");
         if ($this->nmgp_botoes['chart_pizza'] == 'on') {
            ...
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_pizza_off", "", "", "chart_pizza_off_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
         }
         $nm_saida->saida("     <script type=\"text/javascript\">\r\n");
         ...
         $nm_saida->saida("        $('#chart_stack_top').css('display', 'none');\r\n");
         $nm_saida->saida("        $('#chart_stack_on_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("       }\r\n");
         $nm_saida->saida("       else {\r\n");
         $nm_saida->saida("        $('#chart_stack_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("        $('#chart_stack_on_top').css('display', 'none');\r\n");
         $nm_saida->saida("       }\r\n");
         $nm_saida->saida("       $('#chart_stack_off_top').css('display', 'none');\r\n");
         $nm_saida->saida("      }\r\n");
         $nm_saida->saida("      function scDisableStackedColumnChartButton_top() {\r\n");
         $nm_saida->saida("       $('#chart_stack_top').css('display', 'none');\r\n");
         $nm_saida->saida("       $('#chart_stack_on_top').css('display', 'none');\r\n");
         $nm_saida->saida("       $('#chart_stack_off_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("      }\r\n");
         $nm_saida->saida("     </script>\r\n");
         if ($this->nmgp_botoes['chart_stack'] == 'on') {
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_stack", "scChangeChartTypeButton('stackedcolumn2d');", "scChangeChartTypeButton('stackedcolumn2d');", "chart_stack_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "\$('#chart_stack_top').css('display', 'none');\$('#chart_stack_on_top').css('display', 'inline-block');", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_stack_on", "scChangeChartTypeButton('stackedcolumn2d');", "scChangeChartTypeButton('stackedcolumn2d');", "chart_stack_on_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "if (tp_graf_atual != 'stack'){\$('#chart_stack_on_top').css('display', 'none');\$('#chart_stack_top').css('display', 'inline-block');}", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_stack_off", "", "", "chart_stack_off_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
         }
         $nm_saida->saida("     <script type=\"text/javascript\">\r\n");
         ...
         $nm_saida->saida("        $('#chart_combo_top').css('display', 'none');\r\n");
         $nm_saida->saida("        $('#chart_combo_on_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("       }\r\n");
         $nm_saida->saida("       else {\r\n");
         $nm_saida->saida("        $('#chart_combo_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("        $('#chart_combo_on_top').css('display', 'none');\r\n");
         $nm_saida->saida("       }\r\n");
         $nm_saida->saida("       $('#chart_combo_off_top').css('display', 'none');\r\n");
         $nm_saida->saida("      }\r\n");
         $nm_saida->saida("      function scDisableCombinationChartButton_top() {\r\n");
         $nm_saida->saida("       $('#chart_combo_top').css('display', 'none');\r\n");
         $nm_saida->saida("       $('#chart_combo_on_top').css('display', 'none');\r\n");
         $nm_saida->saida("       $('#chart_combo_off_top').css('display', 'inline-block');\r\n");
         $nm_saida->saida("      }\r\n");
         $nm_saida->saida("     </script>\r\n");
         if ($this->nmgp_botoes['chart_combo'] == 'on') {
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_combo", "scChangeChartTypeButton('combination2d');", "scChangeChartTypeButton('combination2d');", "chart_combo_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "\$('#chart_combo_top').css('display', 'none');\$('#chart_combo_on_top').css('display', 'inline-block');", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_combo_on", "scChangeChartTypeButton('combination2d');", "scChangeChartTypeButton('combination2d');", "chart_combo_on_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "if (tp_graf_atual != 'combo'){\$('#chart_combo_on_top').css('display', 'none');\$('#chart_combo_top').css('display', 'inline-block');}", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_combo_off", "", "", "chart_combo_off_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
         }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_simulacao/chart_simulacao_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=pt_br&conf_socor=N&is_chart_app=Y&script_case_init=" . $this->Ini->sc_page . "&app_name=chart_simulacao&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "scChartWordExportShow('direct')", "scChartWordExportShow('direct')", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "scShowCombinationXml()", "scShowCombinationXml()", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "scShowCombinationCsv()", "scShowCombinationCsv()", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['group_2'] == "on")
      {
         ...
         if (is_file("chart_simulacao_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_simulacao_help.txt"); 
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "scChartWordExportShow('direct')", "scChartWordExportShow('direct')", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_3", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "scShowCombinationXls()", "scShowCombinationXls()", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_3", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "scShowCombinationXml()", "scShowCombinationXml()", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_3", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "scShowCombinationCsv()", "scShowCombinationCsv()", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_3", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "scChartPrintExportShow('direct')", "scChartPrintExportShow('direct')", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_3", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
   ...
   function monta_html_fim()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['graf_pdf'] == "S")
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_simulacao_config_pivot.php?nome_apl=chart_simulacao&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"chart_simulacao_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("</form> \r\n");
          ...
          $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "chart_simulacao/chart_simulacao_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
          $nm_saida->saida("       }\r\n");
          $nm_saida->saida("       else\r\n");
          $nm_saida->saida("       {\r\n");
          ...
          $nm_saida->saida("           $('#TB_window').remove();\r\n");
          $nm_saida->saida("           $('body').append(\"<div id='TB_window'></div>\");\r\n");
          $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "chart_simulacao/chart_simulacao_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__cor_print=\" + cor + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
          $nm_saida->saida("       }\r\n");
          $nm_saida->saida("       else\r\n");
          $nm_saida->saida("       {\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_simulacao_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_simulacao@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
          ...
          $nm_saida->saida("      else\r\n");
          $nm_saida->saida("      {\r\n");
          $nm_saida->saida("          window.location = \"" . $this->Ini->path_link . "chart_simulacao/chart_simulacao_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + '&chart_level=' + chart_level + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g;\r\n");
          $nm_saida->saida("      }\r\n");
          $nm_saida->saida("  }\r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "chart_simulacao/chart_simulacao_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
          ...
          $nm_saida->saida(" <div style=\"text-align: center; height: 30px\" id=\"sc-id-hide-comb-table\"><span onclick=\"scHideCombinationTable()\" class=\"scButton_default\" style=\"padding: 3px 15px\">" . $this->Ini->Nm_lang['lang_chart_button_close'] . "</span></div>\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_simulacao_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_simulacao/chart_simulacao_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['skip_charts']))
   {
      ...
      if (!isset($this->progress_fp) || !$this->progress_fp)
      {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['this_chart_label'] = '';
           $this->Graf->monta_grafico($chart_index, 'pdf');
           if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['this_chart_label']) {
               $nm_saida->saida("<script type=\"text/javascript\">$(\"#$random_id\").html(\"{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['this_chart_label']}\")</script>\r\n");
           }
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_simulacao_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['cond_pesq'], 0, $trab_pos);
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " simulacao</div>\r\n");
   ...
   //---- 
   function adiciona_registro($cnt_valorsolicitado, $quebra_created_at, $quebra_created_at_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($cnt_valorsolicitado)) {$cnt_valorsolicitado = '0';}
          eval ('
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT id, taxaJurosMensal, valorSolicitado, qteParcelas, dataPrimeiraParcela, tarifaCadastro, ValorParcela, finalidade, user_id, created_at, updated_at from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT id, taxaJurosMensal, valorSolicitado, qteParcelas, dataPrimeiraParcela, tarifaCadastro, ValorParcela, finalidade, user_id, created_at, updated_at from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->taxajurosmensal = $rs_res->fields[1] ;  
            $this->valorsolicitado = $rs_res->fields[2] ;  
            $this->qteparcelas = $rs_res->fields[3] ;  
            $this->dataprimeiraparcela = $rs_res->fields[4] ;  
            $this->tarifacadastro = $rs_res->fields[5] ;  
            $this->valorparcela = $rs_res->fields[6] ;  
            $this->finalidade = $rs_res->fields[7] ;  
            $this->user_id = $rs_res->fields[8] ;  
            $this->created_at = $rs_res->fields[9] ;  
            $this->updated_at = $rs_res->fields[10] ;  
            $this->created_at_orig = $this->created_at;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valorsolicitado, $this->created_at, $this->created_at_orig);
            }
   }
//
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['save_grid']))
           {
               return;
           }
       } 
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['save_grid']);
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_pesq'] as $cmp => $def)
                {
   ...
   function grid_search_add_tag()
   {
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_pesq']) < 0)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_simulacao']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "facilita/chart_simulacao";
